...
def Call_Window():
    ...
    task = Label(window, text="Title:", bg="#f6e0f4", fg="#8b01a5", font="Courier 12")
    titleEntry = Entry(window, font="Courier", fg="#8b01a5", bg="white")
    description = Label(window, text="Description:", bg="#f6e0f4", fg="#8b01a5", font="Courier 12")
    descriptionEntry = Text(window, height=7, width=25, font="Courier", fg="#8b01a5", bg="white")
    deadline = Label(window, text="Deadline:", bg="#f6e0f4", fg="#8b01a5", font="Courier 12")
    deadlineEntry = Entry(window, font="Courier", fg="#8b01a5", bg="white")
    user = Label(window, text="User:", bg="#f6e0f4", fg="#8b01a5", font="Courier 12")
    ...
    taskButton = Button(window, text="Add Task", bg="white", fg="#8b01a5", font="Courier 12", highlightcolor="#ea8ce1", relief="raised", activebackground="#8b01a5", activeforeground="white")
